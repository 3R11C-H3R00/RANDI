...
<button class="button-34" role="button" onclick="window.location.href='https://wa.link/1l1un7'">⊲ CONTACT ⊳</button>
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://vihaan-3d50.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
            <div class="imager">
 <img src="https://i.ibb.co/M94XJYM/20241206-043539.jpg" alt="Image" class="image">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://v1h44n.onrender.com"'>⊲ CHECK ⊳</button>
    <br />
    <br />
            <div class="imager">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://token-checker-3.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
          <div class="imager">
